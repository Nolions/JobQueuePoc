...
import (
	...
	"github.com/Nolions/jobQueuePoc/internal/httpError"
	"net/http"
...
func New(cachePrefix string, appConf config.App, redisConf redis.Config, dbConf db.Config) *Server {
	handler := newHandler(cachePrefix, appConf, redisConf, dbConf)
